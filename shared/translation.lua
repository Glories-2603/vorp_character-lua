...
Translation.Langs = {
    ...
    Russian = {
        MainMenu = {
            ...
            NewCharDesc = "Чтобы выбрать нажмите ENTER",
            Name = "Имя: ",
            Money = "Деньги: $ ",
            NameDesc = "Чтобы выбрать персонажа нажмите ENTER",
            CreateNewCharT = "Создать персонажа",
            CreateNewCharDesc = "Чтобы выбрать нажмите ENTER",
            Choose = "Войти",
            ChooseDesc = "Выберите этого персонажа, чтобы он появился",
            Delete = "Удалить",
            DeleteDesc = "Удалить персонажа",
            ReturnMenu = "Назад",
            ReturnMenuDesc = "Вернуться назад",
        },
        PromptLabels = {
            promptselect = "| Выбранный персонаж:  ~o~",
            promptselect2 = "~q~ | Деньги: ~o~",
            promptlabel_select = " выберите пол",
            promptlabel_female = "Женский",
            promptlabel_male = "Мужской",
            promptcreateNew = "Создать",
            promptdeleteCurrent = "Удалить",
            promptswapChar = "Пемнять символ",
            promptselectChar = "Выбрать символ",
            promptsexMale = "Мужской",
            promptsexFemale = "Женский",
            promptselectConfirm = "Выбрать",
            promptUpDownCam = "Вверх/Вниз",
            promptrotateCam = "Поворот",
            promptzoomCam = "zoom",
        },
        Inputs = {
            confirm = "Подтвердить",
            placeholder = "ИМЯ ФАМИЛИЯ",
            inputHeader = "Изменять имя",
            title = "Минимум 5, максимум 20 символов",
            banned = "вы не можете использовать это имя, так как оно считается запрещенным на этом сервере"
        },
        MenuCreation = {
            title = "Создание персонажа",
            subtitle = "Sub Menu",
            label = "Name Choosen",
            element = { label = "Внешность", desc = "Выбор внешности для персонажа" },
            element2 = { label = "Одежда", desc = "Выбор одежды" },
            element3 = {
                label = "Сменить имя",
                desc =
                "Выберите имя для своего персонажа убедитесь, что вы ознакомились с правилами присвоения имен персонажам,<br> если вы не будете следовать правилам, этот персонаж будет удален без предупреждения"
            },
            element4 = { label = "Начать путешествие", desc = "Чтобы нначать путешествие нажмите ENTER" },
        },
        MenuClothes = {
            title       = "Одежда",
            subtitle    = "Sub Menu",
            CoatClosed  = "Закрытое пальто",
            Coat        = "Пальто",
            Hat         = "Головной убр",
            EyeWear     = "Очки",
            Mask        = "Маски",
            ...
            Pant        = "Штаны",
            Boots       = "Обувь",
            Spurs       = "Аксссуары для обуви",
            Bracelet    = "Браслеты",
            Buckle      = "Пряжки для ремня",
            Skirt       = "Юбки",
            Chap        = "Чапсы",
            Spats       = "Гетры",
            GunbeltAccs = "Аксессуары для оружейного ремня",
            Gauntlets   = "Рукавицы",
            Loadouts    = "Разгрузки",
            Accessories = "Аксессуары",
            Satchels    = "Сумки и ранцы",
            Dress       = "Платья",
            Holster     = "Левая кобура",
            Gunbelt     = "Оружейный ремень",
            RingRh      = "Кольца справа",
            RingLh      = "Кольца слева",
        },
        MenuComponents = {
            title = "Компоненты",
            subtitle = "Sub Menu",
            element = { label = "Компонент ", desc = "there are " },
            element2 = { label = " Цвет  #", desc = "Выберите цвет компонента" },
        },
        MenuAppearance = {
            title = "Внешность",
            subtitle = "Sub Menu",
            element = { label = "Тело", desc = "Choose the type of your characters body" },
            element2 = { label = "Наследственность", desc = "Choose your characters Herritage" },
            element3 = { label = "Волосы", desc = "Choose you character type of hair" },
            element4 = { label = "Старение", desc = "Character age " },
            element5 = { label = "Рост", desc = "Choose the type of your characters body<br> Tall 3 normal 2 short 1 " },
            element6 = { label = "Лицо", desc = "Choose face features" },
            element7 = { label = "Образ", desc = "choose life style of your character" },
            element8 = { label = "Макияж", desc = "Choose make up" },
            short = "Короткий",
            normal = "Нормальный",
            tall = "Высокий",
        },
        MenuAge = {
            title = "Возраст",
            subtitle = "Sub Menu",
            element = { label = "Возраст", desc = "Choose the age of your character" },
            element2 = { label = "Прозрачность", desc = "there are ", desc2 = "Choose the opacity of your characters age" },
            label3 = "Не видно ",
            label4 = "Видно ",
        },
        MenuBody = {
            title = "Тело",
            subtitle = "Sub Menu",
            element = { label = "Тип тела", desc = "there are ", },
            element2 = { label = "Талия", desc = "there are #", desc2 = "Waist types" },
            element3 = { label = "Торс", desc = "there are " },
            element4 = { label = "Ноги", desc = "there are " },
        },
        MenuHeritage = {
            title = "Наследственность",
            subtitle = "Sub Menu",
            element = { label = "Цвет", desc = "there are ", desc2 = "types of skin color " },
            element2 = { label = "Тип ", desc = "Choose the type of your characters face" },
            element3 = { label = "Наследственность #", desc = " there are #", desc2 = "types of heritage" },
        },
        MenuHair = {
            title = "Волосы",
            subtitle = "Sub Menu",
            element = { label = "Волосы", desc = "Choose characters hair" },
            element2 = { label = "Борода", desc = "Choose characters beard" },
            element3 = { label = "Bear stabble", desc = "Choose characters beard stabble" },
            element4 = { label = "Аксессуары для волос", desc = "Choose characters hair accessories" },
            element5 = { label = "Брови", desc = "Choose characters eye brows" },
            element6 = { label = "Наложить", desc = "Choose characters hair overlay" },
        },
        MenuHairSelection = {
            title = "Волосы",
            subtitle = "Sub Menu",
            element = { label = "Компонент ", desc = "there are ", desc2 = "types of " },
            element2 = { label = "Цвет", desc = "there are ", desc2 = "types of " },
        },
        MenuBeardEyeBrows = {
            title = "Внешность",
            subtitle = "Sub Menu",
            element = { label = "", desc = "choose a type" },
            element2 = { label = "Цвет", desc = "Choose Color" },
            element3 = { label = "Прозрачность", desc = "Choose Opcaity" },
        },
        MenuFacial = {
            title = "Черты лица",
            subtitle = "Sub Menu",
            element = { label = "Цвет глаз", desc = "eye color" },
            element2 = { label = "Зубы", desc = "type of teeth " },
            element3 = { label = "Челюсть", desc = "adjust jaw bone", },
            element4 = { label = "Подбородок", desc = "adjust chin bone" },
            element5 = { label = "Размер головы", desc = "adjust head size " },
            element6 = { label = "Нос", desc = "adjust nose" },
            element7 = { label = "Уши", desc = "adjust ears size" },
            element8 = { label = "Рот и губы", desc = "adjust mouth and lips " },
            element9 = { label = "Скулы", desc = "Choose characters facial hair opacity" },
            element10 = { label = "Глаза и брови", desc = "adjust cheek bokes" },
        },
        MenuFaceModify = {
            title = "Черты лица",
            subtitle = "Sub Menu",
            element = { label = "", desc = "выбрать: " },
        },
        MenuLifeStyle = {
            title = "Образ",
            subtitle = "Sub Menu",
            label = " Прозрачность",
            desc = "Выберите прозрачность",
            element = { label = "Моль", desc = "Choose life style of your character" },
            element2 = { label = "Пятна", desc = "Choose life style opacity of your character" },
            element3 = { label = "Совокупность", desc = "Choose life style opacity of your character" },
            element4 = { label = "Акне", desc = "Choose life style opacity of your character" },
            element5 = { label = "Веснушки", desc = "Choose life style opacity of your character" },
            element6 = { label = "Бледость", desc = "Choose life style opacity of your character" },
            element7 = { label = "Шрамы", desc = "Choose life style opacity of your character" },
            element8 = { label = "Грим", desc = "Choose life style opacity of your character" },
        },
        MenuMakeup = {
            title = "Макияж",
            subtitle = "Sub Menu",
            element = { label = "Губная помада", desc = "Choose makeup of your character" },
            element2 = { label = "Румянец", desc = "Choose makeup  of your character" },
            element3 = { label = "Карандаш для глаз", desc = "Choose makeup of your character" },
            element4 = { label = "Тени", desc = "Choose makeup of your character" },
            element5 = { label = "Текстура", desc = "Choose makeupof your character" },
            element6 = { label = "Цвет", desc = "Choose makeup of your character" },
            element7 = { label = "Вторичный Цвет", desc = "Choose makeup of your character" },
            element8 = { label = "Вариант", desc = "Choose the makeup variant" },
            element9 = { label = "Прозрачность", desc = "Choose makeup  of your character" },
        },
    },
}
